              ...
              <ul className="sm-socials-list" role="list">
                {socialItems.map((s, i) => (
                  <li key={s.label + i} className="sm-socials-item">
                    <a href={s.link} target="_blank" rel="noopener noreferrer" className="sm-socials-link flex items-center justify-center p-2 rounded-full hover:bg-black/5 transition-colors">
                      {s.icon || s.label}
                    </a>
                  </li>
                ))}
